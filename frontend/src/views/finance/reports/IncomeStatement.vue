...
const generateReport = async () => {
  ...
  loading.value = true;
  try {
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/finance/reports/income-statement`, {
      params: {
...
const exportExcel = () => {
  ...
  // 生成Excel文件并下载
  XLSX.writeFile(wb, `利润表_${queryParams.startDate}_${queryParams.endDate}.xlsx`);
};
